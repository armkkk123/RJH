...
function Library.new(config)
	...
	local defaultSize = UDim2.new(0, 440, 0, 550)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			Description.Position = UDim2.new(0.5, 0, 0, 42)
	...
	-- ▂▂▂ BACKGROUND GRADIENT (deep purple-black atmosphere) ▂▂▂
	...
	-- ▂▂▂ MASSIVE GLOW EXPLOSION (behind logo) ▂▂▂
	local MegaGlow = Instance.new("ImageLabel")
	MegaGlow.Name = "MegaGlow"
	MegaGlow.Parent = LoadScreen
	MegaGlow.AnchorPoint = Vector2.new(0.5, 0.5)
	MegaGlow.Position = UDim2.new(0.5, 0, 0.45, 0)
	MegaGlow.Size = UDim2.new(0, 0, 0, 0)
	MegaGlow.BackgroundTransparency = 1
	MegaGlow.Image = "rbxassetid://6015897843"
	MegaGlow.ImageColor3 = Color3.fromHex("#c542cb")
	MegaGlow.ImageTransparency = 1
	MegaGlow.ScaleType = Enum.ScaleType.Slice
	MegaGlow.SliceCenter = Rect.new(49, 49, 450, 450)
	MegaGlow.ZIndex = 501

	-- Secondary warm glow
	local WarmGlow = Instance.new("ImageLabel")
	WarmGlow.Name = "WarmGlow"
	WarmGlow.Parent = LoadScreen
	WarmGlow.AnchorPoint = Vector2.new(0.5, 0.5)
	WarmGlow.Position = UDim2.new(0.5, 0, 0.45, 0)
	WarmGlow.Size = UDim2.new(0, 0, 0, 0)
	WarmGlow.BackgroundTransparency = 1
	WarmGlow.Image = "rbxassetid://6015897843"
	WarmGlow.ImageColor3 = Color3.fromHex("#ff6bff")
	WarmGlow.ImageTransparency = 1
	WarmGlow.ScaleType = Enum.ScaleType.Slice
	WarmGlow.SliceCenter = Rect.new(49, 49, 450, 450)
	WarmGlow.ZIndex = 501

	-- ▂▂▂ SPINNING OUTER RING ▂▂▂
	local OuterRing = Instance.new("ImageLabel")
	OuterRing.Parent = LoadScreen
	OuterRing.AnchorPoint = Vector2.new(0.5, 0.5)
	OuterRing.Position = UDim2.new(0.5, 0, 0.45, 0)
	OuterRing.Size = UDim2.new(0, 0, 0, 0)
	OuterRing.BackgroundTransparency = 1
	OuterRing.Image = "rbxassetid://11963373994"
	OuterRing.ImageColor3 = Color3.fromHex("#f985ff")
	OuterRing.ImageTransparency = 1
	OuterRing.ZIndex = 503

	-- ▂▂▂ INNER RING (spins opposite) ▂▂▂
	local InnerRing = Instance.new("ImageLabel")
	InnerRing.Parent = LoadScreen
	InnerRing.AnchorPoint = Vector2.new(0.5, 0.5)
	InnerRing.Position = UDim2.new(0.5, 0, 0.45, 0)
	InnerRing.Size = UDim2.new(0, 0, 0, 0)
	InnerRing.BackgroundTransparency = 1
	InnerRing.Image = "rbxassetid://11963373994"
	InnerRing.ImageColor3 = Color3.fromHex("#ffffff")
	InnerRing.ImageTransparency = 1
	InnerRing.ZIndex = 502

	-- ▂▂▂ LOGO (starts tiny, will zoom dramatically) ▂▂▂
	local LoadLogo = Instance.new("ImageLabel")
	LoadLogo.Parent = LoadScreen
	LoadLogo.AnchorPoint = Vector2.new(0.5, 0.5)
	LoadLogo.Position = UDim2.new(0.5, 0, 0.45, 0)
	LoadLogo.Size = UDim2.new(0, 8, 0, 8)
	LoadLogo.BackgroundTransparency = 1
	LoadLogo.Image = config.Logo or "rbxassetid://108548419189473"
	LoadLogo.ImageTransparency = 1
	LoadLogo.ZIndex = 505
	local LogoCorner = Instance.new("UICorner")
	LogoCorner.CornerRadius = UDim.new(0.15, 0)
	LogoCorner.Parent = LoadLogo

	-- ▂▂▂ TITLE "RUAJAD HUB" ▂▂▂
	local LoadTitle = Instance.new("TextLabel")
	LoadTitle.Parent = LoadScreen
	LoadTitle.AnchorPoint = Vector2.new(0.5, 0)
	LoadTitle.Position = UDim2.new(0.5, 0, 0.6, 0)
	LoadTitle.Size = UDim2.new(0.8, 0, 0, 40)
	...
	LoadTitle.ZIndex = 506

	-- Title stroke for premium look
	local TitleStroke = Instance.new("UIStroke")
	TitleStroke.Parent = LoadTitle
	TitleStroke.Color = Color3.fromHex("#c542cb")
	...
	LoadSub.Position = UDim2.new(0.5, 0, 0.67, 0)
	LoadSub.Size = UDim2.new(0.6, 0, 0, 18)
	LoadSub.BackgroundTransparency = 1
	LoadSub.Font = Enum.Font.Gotham
	LoadSub.Text = ""
	LoadSub.TextColor3 = Color3.fromRGB(200, 180, 220)
	...
	ProgBg.Parent = LoadScreen
	ProgBg.AnchorPoint = Vector2.new(0.5, 0)
	ProgBg.Position = UDim2.new(0.5, 0, 0.78, 0)
	...
	ProgFill.BackgroundColor3 = Color3.fromHex("#f985ff")
	ProgFill.BorderSizePixel = 0
	ProgFill.ZIndex = 507
	Instance.new("UICorner", ProgFill).CornerRadius = UDim.new(1, 0)
	local FillGrad = Instance.new("UIGradient")
	FillGrad.Parent = ProgFill
	FillGrad.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromHex("#8b20a8")),
		ColorSequenceKeypoint.new(0.5, Color3.fromHex("#f985ff")),
		ColorSequenceKeypoint.new(1, Color3.fromHex("#ffffff"))
	})

	-- ▂▂▂ STATUS TEXT ▂▂▂
	local StatusTxt = Instance.new("TextLabel")
	StatusTxt.Parent = LoadScreen
	StatusTxt.AnchorPoint = Vector2.new(0.5, 0)
	StatusTxt.Position = UDim2.new(0.5, 0, 0.82, 0)
	StatusTxt.Size = UDim2.new(0.5, 0, 0, 14)
	StatusTxt.BackgroundTransparency = 1
	StatusTxt.Font = Enum.Font.Code
	StatusTxt.Text = ""
	StatusTxt.TextColor3 = Color3.fromRGB(100, 100, 120)
	StatusTxt.TextTransparency = 1
	StatusTxt.TextSize = 11
	StatusTxt.ZIndex = 506
	...
	-- ▂▂▂ GLITCH LINE (horizontal glitch bar) ▂▂▂
	...
	-- ▂▂▂ PARTICLE DOTS (floating ambient particles) ▂▂▂
	local Particles = {}
	for i = 1, 20 do
		local dot = Instance.new("Frame")
		dot.Parent = LoadScreen
		dot.BackgroundColor3 = Color3.fromHex(i % 2 == 0 and "#f985ff" or "#ffffff")
	...
	task.spawn(function()
		...
		-- ═══ ACT 1: DARKNESS — Letterbox bars slide in (0.0s) ═══
		Twen:Create(TopBar, TI(0.8, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2.new(0, 0, 0, 0)}):Play()
		Twen:Create(BottomBar, TI(0.8, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2.new(0, 0, 0.88, 0)}):Play()
		task.wait(0.5)

		-- ═══ ACT 2: BIRTH — Tiny spark grows into logo (0.5s) ═══
		-- First flash: a brief glitch spark
		GlitchBar.BackgroundTransparency = 0.3
		GlitchBar.Position = UDim2.new(0, 0, math.random() * 0.4 + 0.3, 0)
		task.wait(0.05)
		GlitchBar.BackgroundTransparency = 1
		task.wait(0.1)
		GlitchBar.BackgroundTransparency = 0.5
		GlitchBar.Position = UDim2.new(0, 0, math.random() * 0.4 + 0.3, 0)
		task.wait(0.03)
		GlitchBar.BackgroundTransparency = 1

		-- Logo zoom from tiny to dramatic size
		Twen:Create(LoadLogo, TI(0.8, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Size = UDim2.new(0, 70, 0, 70),
			ImageTransparency = 0
		}):Play()

		-- Glow explosion behind logo
		Twen:Create(MegaGlow, TI(1.0, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			Size = UDim2.new(0, 350, 0, 350),
			ImageTransparency = 0.5
		}):Play()
		Twen:Create(WarmGlow, TI(1.2, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			Size = UDim2.new(0, 250, 0, 250),
			ImageTransparency = 0.6
		}):Play()

		-- Rings appear and start spinning
		Twen:Create(OuterRing, TI(0.7, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Size = UDim2.new(0, 110, 0, 110),
			ImageTransparency = 0.2
		}):Play()
		Twen:Create(InnerRing, TI(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			Size = UDim2.new(0, 85, 0, 85),
			ImageTransparency = 0.5
		}):Play()

		-- Spin rings continuously
		task.spawn(function()
			while not LoadingDone do
				OuterRing.Rotation = OuterRing.Rotation + 4
				InnerRing.Rotation = InnerRing.Rotation - 2.5
				task.wait()
			end
		end)
		...
		task.spawn(function()
			while not LoadingDone do
				Twen:Create(MegaGlow, TI(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
					ImageTransparency = 0.35,
					Size = UDim2.new(0, 400, 0, 400)
				}):Play()
				Twen:Create(WarmGlow, TI(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
					ImageTransparency = 0.5,
		...
		task.spawn(function()
			for _, dot in ipairs(Particles) do
				task.spawn(function()
					...
					task.wait(delay)
					Twen:Create(dot, TI(0.4, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.4}):Play()
					while not LoadingDone do
						local dur = math.random() * 2 + 1.5
						Twen:Create(dot, TI(dur, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
							Position = UDim2.new(math.random() * 0.8 + 0.1, 0, math.random() * 0.5 + 0.15, 0),
		...
		-- ═══ ACT 3: TITLE REVEAL — Dramatic typewriter with glitch (1.1s) ═══
		LoadTitle.TextTransparency = 0
		TitleStroke.Transparency = 0.3
		local titleStr = "RUAJAD HUB"
		for i = 1, #titleStr do
			LoadTitle.Text = string.sub(titleStr, 1, i)
			-- Random micro-glitch during typing
			if math.random() > 0.6 then
				local origColor = LoadTitle.TextColor3
				LoadTitle.TextColor3 = Color3.fromHex("#f985ff")
				task.wait(0.02)
				LoadTitle.TextColor3 = origColor
			end
			task.wait(0.055)
		end

		-- Title glow pulse after completion
		Twen:Create(TitleStroke, TI(0.5, Enum.EasingStyle.Quint), {
			Color = Color3.fromHex("#f985ff"),
			Transparency = 0
		}):Play()
		task.wait(0.15)
		Twen:Create(TitleStroke, TI(0.8, Enum.EasingStyle.Quint), {
			Transparency = 0.6
		}):Play()

		-- Show subtitle
		LoadSub.Text = config.Description or "Powered by RUAJAD"
		Twen:Create(LoadSub, TI(0.5, Enum.EasingStyle.Quint), {TextTransparency = 0.3}):Play()

		task.wait(0.2)

		-- ═══ ACT 4: SYSTEMS ONLINE — Progress bar with combat statuses (1.9s) ═══
		Twen:Create(ProgBg, TI(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.3}):Play()
		Twen:Create(StatusTxt, TI(0.3, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()

		local loadSteps = {
			{txt = ">> Deploying anti-detection shield...",   pct = 0.12, dur = 0.35},
			{txt = ">> Compiling combat modules...",          pct = 0.28, dur = 0.30},
			{txt = ">> Injecting stealth framework...",       pct = 0.45, dur = 0.35},
			{txt = ">> Synchronizing exploit engine...",      pct = 0.60, dur = 0.30},
			{txt = ">> Calibrating neural interface...",      pct = 0.78, dur = 0.25},
			{txt = ">> Loading weapon systems...",            pct = 0.92, dur = 0.25},
			{txt = ">> ALL SYSTEMS ARMED ✓",                 pct = 1.00, dur = 0.20},
		}

		for _, step in ipairs(loadSteps) do
			StatusTxt.Text = step.txt
			Twen:Create(ProgFill, TI(step.dur, Enum.EasingStyle.Quint), {
		...
		-- Final status flash green
		StatusTxt.TextColor3 = Color3.fromRGB(0, 255, 120)
		task.wait(0.4)

		-- ═══ ACT 5: DRAMATIC EXIT — Camera zoom + white flash + fade ═══
		LoadingDone = true

		-- Logo zoom out dramatically
		Twen:Create(LoadLogo, TI(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
			Size = UDim2.new(0, 200, 0, 200),
			ImageTransparency = 0.8
		}):Play()

		-- Rings explode outward
		Twen:Create(OuterRing, TI(0.5, Enum.EasingStyle.Quint), {
			Size = UDim2.new(0, 500, 0, 500),
			ImageTransparency = 1
		}):Play()
		Twen:Create(InnerRing, TI(0.5, Enum.EasingStyle.Quint), {
			Size = UDim2.new(0, 400, 0, 400),
			ImageTransparency = 1
		}):Play()

		-- Glow supernova
		Twen:Create(MegaGlow, TI(0.4, Enum.EasingStyle.Quint), {
			Size = UDim2.new(0, 800, 0, 800),
			ImageTransparency = 0.2
		}):Play()

		-- Fade all text
		Twen:Create(LoadTitle, TI(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
		Twen:Create(TitleStroke, TI(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
		Twen:Create(LoadSub, TI(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
		Twen:Create(StatusTxt, TI(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
		Twen:Create(ProgBg, TI(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
		Twen:Create(ProgFill, TI(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()

		-- Kill particles
		for _, dot in ipairs(Particles) do
			Twen:Create(dot, TI(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
		end

		task.wait(0.35)

		-- ★★★ WHITE FLASH — THE MONEY SHOT ★★★
		Twen:Create(WhiteFlash, TI(0.08), {BackgroundTransparency = 0.15}):Play()
		task.wait(0.1)
		Twen:Create(WhiteFlash, TI(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()

		-- Glow fade
		Twen:Create(MegaGlow, TI(0.5, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
		Twen:Create(WarmGlow, TI(0.5, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()

		-- Letterbox bars retreat
		Twen:Create(TopBar, TI(0.6, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {Position = UDim2.new(0, 0, -0.12, 0)}):Play()
		Twen:Create(BottomBar, TI(0.6, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {Position = UDim2.new(0, 0, 1, 0)}):Play()

		-- Final full fade
		task.wait(0.2)
		Twen:Create(LoadScreen, TI(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
		task.wait(0.6)
		LoadScreen:Destroy()
	end)
	-- ============================================================
	...
	MainGradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromHex("#f985ff")), -- สีสว่างด้านบน
		ColorSequenceKeypoint.new(1, Color3.fromHex("#c542cb")) -- สีเข้มเล็กน้อยด้านล่าง
	})
	MainFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
	...
	AvatarImage.BackgroundColor3 = Theme.Colors.SubPanel
	...
	NameText.TextColor3 = Theme.Colors.Main
	...
	Title.Position = UDim2.new(0.42, 0, 0, 12)
	...
	Description.Position = UDim2.new(0.42, 0, 0, 36)
	Description.Size = UDim2.new(0.55, 0, 0, 28)
	...
	MainTabFrame.Position = UDim2.new(0.5, 0, 0, 115) 
	MainTabFrame.AnchorPoint = Vector2.new(0.5, 0)
	MainTabFrame.Size = UDim2.new(1, -16, 1, -112)
	...
	function WindowTable:NewTab(cfg)
		...
		local desiredWidth = math.max(100, titleBounds.X + 60) -- 60px buffer for icon and padding
		...
		Icon.LayoutOrder = 1
		Icon.ZIndex = 6
		Icon.Image = (cfg.Icon and (Icons[cfg.Icon] or cfg.Icon)) or "rbxassetid://10888331510" -- Generic default icon
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			function SectionTable:NewDropdown(drop)
				...
				TextInt.BorderColor3 = Color3.fromRGB(0, 0, 0)
				TextInt.BorderSizePixel = 0
				TextInt.Position = UDim2.new(0.5, 0, 0.20, 0)
				...
				MFrame.BorderSizePixel = 0
				MFrame.ClipsDescendants = true
				MFrame.Position = UDim2.new(0.5, 0, 0.70, 0)
				MFrame.Size = UDim2.new(0.95, 0, 0.45, 0)
				MFrame.ZIndex = 18
