...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			Twen:Create(TabButtonFrame,TweenInfo1,{Position = UDim2.fromScale(0.5,0.21)}):Play();
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.fromScale(0.5,0.30)}):Play();
			...
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.fromScale(1.5,0.30)}):Play();
	...
	Headers.Size = UDim2.new(0.31, 0, 0.195, 0)
	Headers.ZIndex = 3
	...
	TabButtonFrame.Position = UDim2.new(0.5, 0, 0.21, 0)
	TabButtonFrame.Size = UDim2.new(0.96, 0, 0.08, 0)
	...
	MainTabFrame.Position = UDim2.new(0.5, 0, 0.30, 0)
	MainTabFrame.Size = UDim2.new(0.96, 0, 0.68, 0)
	...
	function WindowTable:NewTab(cfg)
		...
		TabButton.Size = UDim2.new(0.18, 0, 0.9, 0)
		TabButton.ZIndex = 5
		...
		local TabTitleConstraint = Instance.new("UITextSizeConstraint")
		TabTitleConstraint.MinTextSize = 8
		TabTitleConstraint.MaxTextSize = 13
		TabTitleConstraint.Parent = Title
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			SectionTitleConstraint.MinTextSize = 9
			SectionTitleConstraint.MaxTextSize = 14
			SectionTitleConstraint.Parent = Title
			...
			function SectionTable:NewToggle(toggle)
				...
				ToggleTextConstraint.MinTextSize = 9
				ToggleTextConstraint.MaxTextSize = 14
				ToggleTextConstraint.Parent = TextInt
			...
			function SectionTable:NewTitle(lrm)
				...
				BtnTextConstraint.MinTextSize = 9
				BtnTextConstraint.MaxTextSize = 14
				BtnTextConstraint.Parent = TextInt
			...
			function SectionTable:NewButton(cfg)
				...
				local SliderTextConstraint = Instance.new("UITextSizeConstraint")
				SliderTextConstraint.MinTextSize = 9
				SliderTextConstraint.MaxTextSize = 14
				SliderTextConstraint.Parent = TextInt
			...
			function SectionTable:NewLabel(conf)
				...
				LabelTextConstraint.Parent = TextInt
			...
			function SectionTable:NewSlider(slider)
				...
				local SliderTitleConstraint = Instance.new("UITextSizeConstraint")
				SliderTitleConstraint.MinTextSize = 9
				SliderTitleConstraint.MaxTextSize = 14
				SliderTitleConstraint.Parent = TextInt
			...
			function SectionTable:NewDropdown(drop)
				...
				local DropTextConstraint = Instance.new("UITextSizeConstraint")
				DropTextConstraint.MinTextSize = 9
				DropTextConstraint.MaxTextSize = 14
				DropTextConstraint.Parent = TextInt
