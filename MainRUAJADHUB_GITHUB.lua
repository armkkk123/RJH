...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			TabButtonFrame.Position = UDim2.new(0, 8, 0.5, 30)
			TabButtonFrame.Size = UDim2.new(0, 110, 1, -110)
			TabButtonFrame.AnchorPoint = Vector2.new(0, 0.5)
			TabButtonFrame.Visible = true

			MainTabFrame.Position = UDim2.new(0, 125, 0, 80)
			MainTabFrame.Size = UDim2.new(1, -133, 1, -95)
			MainTabFrame.AnchorPoint = Vector2.new(0, 0)
			MainTabFrame.Visible = true

			ImageButton.Position = UDim2.new(1, -60, 0.01, 0)
			ImageButton.Size = UDim2.new(40, 0, 40, 0)
	...
	Title.Position = UDim2.new(0.365, 0, 0, 12)
	...
	Description.Position = UDim2.new(0.365, 0, 0, 36)
	...
	TabButtonFrame.Size = UDim2.new(0, 110, 1, -110)
	TabButtonFrame.AnchorPoint = Vector2.new(0, 0.5) 
	Twen:Create(TabButtonFrame,TweenInfo2,{BackgroundTransparency = 1}):Play(); -- Keep sidebar transparent for cleaner look
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			SectionAutoUI:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
				Twen:Create(Section,TweenInfo.new(0.1),{
					Size = UDim2.new(0.92,0,0,math.max(SectionAutoUI.AbsoluteContentSize.Y,50) + (SectionAutoUI.Padding.Offset * 1.12) + 8);
				}):Play()
			end)
			...
			function SectionTable:NewSlider(slider)
				...
				TextInt.BorderSizePixel = 0
				TextInt.Position = UDim2.new(0.025, 0, 0.5, 0)
				TextInt.Size = UDim2.new(0.4, 0, 0.6, 0)
				TextInt.ZIndex = 18
				TextInt.Font = Enum.Font.GothamBold
				...
				ValueText.Position = UDim2.new(0.975, 0, 0.26, 0)
				ValueText.Size = UDim2.new(0.4, 0, 0.35, 0)
				...
				MFrame.AnchorPoint = Vector2.new(1, 0.5)
				...
				MFrame.Position = UDim2.new(0.975, 0, 0.5, 0)
				MFrame.Size = UDim2.new(0.5, 0, 0.5, 0)
				MFrame.ZIndex = 18
			...
			function SectionTable:NewDropdown(drop)
				...
				TextInt.BorderSizePixel = 0
				TextInt.Position = UDim2.new(0.025, 0, 0.5, 0)
				TextInt.Size = UDim2.new(0.5, 0, 0.6, 0)
				TextInt.ZIndex = 18
				TextInt.Font = Enum.Font.GothamBold
				...
				MFrame.ClipsDescendants = true
				MFrame.Position = UDim2.new(0.975, 0, 0.5, 0)
				MFrame.Size = UDim2.new(0.45, 0, 0.7, 0)
				MFrame.ZIndex = 18
				...
				ValueText.Size = UDim2.new(1, 0, 0.7, 0)
				ValueText.ZIndex = 18
				ValueText.Font = Enum.Font.GothamBold
				...
				Chevron.Parent = MFrame
				Chevron.AnchorPoint = Vector2.new(1, 0.5)
				Chevron.BackgroundTransparency = 1
				Chevron.Size = UDim2.new(0, 16, 0, 16)
				Chevron.Position = UDim2.new(0.98, 0, 0.5, 0)
				Chevron.Image = "rbxassetid://6034818372" -- Chevron down icon
