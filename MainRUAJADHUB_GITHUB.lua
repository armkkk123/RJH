...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			Twen:Create(TabButtonFrame,TweenInfo1,{Position = UDim2.new(0.34, 0, 0, 64)}):Play();
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.new(0.5, 0, 0, 104)}):Play();
			Twen:Create(Description,TweenInfo1,{Position = UDim2.new(0.34, 0, 0, 34)}):Play();

			Twen:Create(Title,TweenInfo1,{Position = UDim2.new(0.34, 0, 0, 12)}):Play();
	...
	BlockFrame2.Position = UDim2.new(0.5, 0, 0, 100)
	...
	TabButtonFrame.Position = UDim2.new(0.34, 0, 0, 64) 
	TabButtonFrame.Size = UDim2.new(0.64, 0, 0, 32) 
