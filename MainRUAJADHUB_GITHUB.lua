...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			Twen:Create(BlockFrame2,TweenInfo1,{BackgroundTransparency = 0.3}):Play();
			Twen:Create(BlockFrame3,TweenInfo1,{BackgroundTransparency = 1}):Play();

			Twen:Create(TabButtonFrame,TweenInfo1,{Position = UDim2.fromScale(0.5,0.12)}):Play();
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.fromScale(0.5,0.24)}):Play();
			...
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.fromScale(1.5,0.24)}):Play();
	...
	BlockFrame2.Position = UDim2.new(0.5, 0, 0.225, 0)
	...
	TabButtonFrame.Position = UDim2.new(0.5, 0, 0.12, 0)
	TabButtonFrame.Size = UDim2.new(0.96, 0, 0.10, 0)
	...
	MainTabFrame.Position = UDim2.new(0.5, 0, 0.24, 0)
	MainTabFrame.Size = UDim2.new(0.96, 0, 0.74, 0)
	...
	function WindowTable:NewTab(cfg)
		...
		Icon.Position = UDim2.new(0.2, 0, 0.5, 0)
		Icon.Size = UDim2.new(0.500000000, 0, 0.500000000, 0)
