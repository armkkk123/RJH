...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			MainTabFrame.Size = UDim2.new(0.96, 0, 1, -135)
	...
	MainTabFrame.Size = UDim2.new(0.96, 0, 1, -130)
	MainTabFrame.AnchorPoint = Vector2.new(0.5, 0)	MainTabFrame.Size = UDim2.new(0.96, 0, 1, -112) 
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			function SectionTable:NewDropdown(drop)
				...
				ValueText.Font = Enum.Font.GothamBold
					...
					ValueText.Text = tostring(drop.Default)
				end;
				ValueText.TextColor3 = Color3.fromRGB(255, 255, 255)
				ValueText.TextScaled = false
