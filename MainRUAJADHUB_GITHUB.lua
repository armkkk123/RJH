...
function Library.new(config)
	...
	function WindowTable:NewTab(cfg)
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			Title.TextColor3 = Color3.fromRGB(255, 255, 255)
			Title.TextScaled = true
			local _tscH = Instance.new("UITextSizeConstraint"); _tscH.MaxTextSize = 14; _tscH.Parent = Title
			Title.TextWrapped = true
			Title.TextXAlignment = Enum.TextXAlignment.Left
			Title.TextTransparency = 1
			Twen:Create(Title,TweenInfo2,{TextTransparency = 0}):Play();
			...
			function SectionTable:NewToggle(toggle)
				...
				local _tsc1 = Instance.new("UITextSizeConstraint"); _tsc1.MaxTextSize = 14; _tsc1.Parent = TextInt
			...
			function SectionTable:NewButton(cfg)
				...
				TextInt.TextColor3 = Color3.fromRGB(255, 255, 255)
				TextInt.TextScaled = true
				local _tscB = Instance.new("UITextSizeConstraint"); _tscB.MaxTextSize = 14; _tscB.Parent = TextInt
				TextInt.TextWrapped = true
			...
			function SectionTable:NewLabel(conf)
				...
				TextInt.TextScaled = true
				local _tsc2 = Instance.new("UITextSizeConstraint"); _tsc2.MaxTextSize = 14; _tsc2.Parent = TextInt
			...
			function SectionTable:NewSlider(slider)
				...
				TextInt.TextColor3 = Color3.fromRGB(255, 255, 255)
				TextInt.TextScaled = true
				local _tsc3 = Instance.new("UITextSizeConstraint"); _tsc3.MaxTextSize = 14; _tsc3.Parent = TextInt
				TextInt.TextTransparency = 0.250
				TextInt.TextWrapped = true
				TextInt.TextXAlignment = Enum.TextXAlignment.Left
			...
			function SectionTable:NewDropdown(drop)
				...
				TextInt.TextColor3 = Color3.fromRGB(255, 255, 255)
				TextInt.TextScaled = true
				local _tsc4 = Instance.new("UITextSizeConstraint"); _tsc4.MaxTextSize = 14; _tsc4.Parent = TextInt
				TextInt.TextTransparency = 0.250
				TextInt.TextWrapped = true
				TextInt.TextXAlignment = Enum.TextXAlignment.Left
