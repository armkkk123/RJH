...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			...
			Twen:Create(TabButtonFrame,TweenInfo1,{Position = UDim2.new(0.33, 0, 0, 64)}):Play();
			Twen:Create(MainTabFrame,TweenInfo1,{Position = UDim2.new(0.5, 0, 0, 104)}):Play();
	...
	Title.Position = UDim2.new(0.33, 0, 0, 12)
	...
	Description.Position = UDim2.new(0.33, 0, 0, 36)
	Description.Size = UDim2.new(0.65, 0, 0, 28)
	...
	TabButtonFrame.Position = UDim2.new(0.33, 0, 0, 64) 
	TabButtonFrame.Size = UDim2.new(0.65, 0, 0, 32) 
	...
	MainTabFrame.Position = UDim2.new(0.5, 0, 0, 104) 
	MainTabFrame.Size = UDim2.new(0.96, 0, 1, -112) 
	...
	function WindowTable:NewTab(cfg)
		...
		Title.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Title.BorderSizePixel = 0
		Title.Size = UDim2.new(0, titleBounds.X + 2, 1, 0)
		Title.LayoutOrder = 2
		Title.Font = Enum.Font.GothamBold
